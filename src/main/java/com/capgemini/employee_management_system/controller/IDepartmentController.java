...
import com.capgemini.employee_management_system.entity.Department;
import com.capgemini.employee_management_system.service.IDepartmentService;
...
/*********************************************************************************************************************
	...
	public ResponseEntity<List<Department>> getAllDepartmentByPagination(@PathVariable("maxPage") String maxPage) throws DepartmentNotFoundException
	{
